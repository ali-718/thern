    ...
    <HeroArea>
          ...
          slideTextArr.map((slideText, i) => (
            <div className="item" key={`main-slide-${i}`}>
              <SlideContent>
                ...
                {/* <SlideBg
                  fluid={require("../../../assets/img/logo/project.jpg")}
                /> */}
      ...
      <SlideNavWrap>
        <div className="col-4 offset-1">
          <Slider {...navSliderOpt}>
            {slideNavArr &&
              slideNavArr.map((slideNav, i) => (
                <div className="item">
                  <SlideNav>
                    {slideNav.subtitle && (
                      <Text {...navSubtitleStyle}>{slideNav.subtitle}</Text>
                    )}
                    {slideNav.title && (
                      <Heading {...navTitleStyle}>{slideNav.title}</Heading>
                    )}
                  </SlideNav>
                </div>
              ))}
